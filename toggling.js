		...
		chrome.tabs.query({}, function(tabs){
			...
			if(tabsToDeny.length > 0){
				...
				chrome.storage.sync.set({'isEnabled': true}, function() {
				 ...
				 // This is old code that prompted the user to confirm that some tabs were going to be closed
				 // If it's just for me, I'm fine closing tabs without notifying the user
